...
object Repository {
        ...
        get() = Realm.getInstance(RealmConfiguration.Builder(App.context)
                ...
                .migration { realm: DynamicRealm, oldVersion: Long, newVersion: Long ->
                    ...
                    if (oldVersion.toInt() == 1) {
                        routineSchema.addField("title", String::class.java).addField("subtitle", String::class.java).transform { obj: DynamicRealmObject ->
    ...
    fun buildRealmRoutine(routine: Routine): RepositoryRoutine {
        ...
        val repositoryRoutine = realm.createObject(RepositoryRoutine::class.java)
        repositoryRoutine.id = "Routine-" + UUID.randomUUID().toString()
        ...
        repositoryRoutine.startTime = DateTime().toDate()
        ...
        for (exercise in routine.exercises) {
            ...
            if (repositoryCategory == null || !repositoryCategory.title.equals(exercise.category!!.title, ignoreCase = true)) {
                ...
                repositoryRoutine.categories.add(repositoryCategory)
            }
            ...
            if (repositorySection == null || !repositorySection.title.equals(exercise.section!!.title, ignoreCase = true)) {
                ...
                repositoryRoutine.sections.add(repositorySection)
    ...
    val repositoryRoutineForToday: RepositoryRoutine
        get() {
            ...
            var repositoryRoutine: RepositoryRoutine? = realm.where(RepositoryRoutine::class.java).between("startTime", start, end).equalTo("routineId", routineId).findFirst()
