package com.bodyweight.fitness.view.graph;
...
import com.bodyweight.fitness.utils.MyUtils;
...
public class LineView extends View {
    ...
    //popup 컬러
    private int[] popupColorArray = {R.drawable.ic_add, R.drawable.ic_add, R.drawable.ic_add};
